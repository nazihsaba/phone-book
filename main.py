...
frame_table.grid(row=2, column=0, columnspan=2, padx=20, pady=1, sticky=NW)

# functions
def show():
    global tree # to access it everywhere

    listheader=['Name', 'Gender', 'Telephone', 'Emaal']
...
def to_update():
    try:
        ...
        def confirm():
            ...
            show()
        # Confirm Button
        b_confirm = Button(frame_down, text = "Confirm", height=1, width=10, bg= co2, fg=co0, font=('Ivy 8 bold'), command= confirm)
...
# View Button
b_view = Button(frame_down, text = "View", height=1, width=10, bg= co2, fg=co0, font=('Ivy 8 bold'), command= show)
b_view.place(x=290, y=50)
# Add button
b_add = Button(frame_down, text = "Add", height=1, width=10, bg= co2, fg=co0, font=('Ivy 8 bold'), command=insert)
b_add.place(x=400, y=50)
# Update Button
b_update = Button(frame_down, text = "Update", height=1, width=10, bg= co2, fg=co0, font=('Ivy 8 bold'), command= to_update)
b_update.place(x=400, y=80)
# Delete Button
b_delete = Button(frame_down, text = "Delete", height=1, width=10, bg= co2, fg=co0, font=('Ivy 8 bold'), command=to_remove)
b_delete.place(x=400, y=110)


window.mainloop() # to be able to run